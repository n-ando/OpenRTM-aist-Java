...
import jp.go.aist.rtm.rtclink.model.component.impl.ComponentPackageImpl;
...
public class NameservicePackageImpl extends EPackageImpl implements NameservicePackage {
	 ...
	 * @see jp.go.aist.rtm.rtclink.model.nameservice.NameservicePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		addEOperation(nodeEClass, null, "deleteR");
		...
		EOperation op = addEOperation(nameServiceReferenceEClass, this.getNameServiceReference(), "createMergedNameServiceReference");
		addEParameter(op, this.getBinding(), "childBinding");
