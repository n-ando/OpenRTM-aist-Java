...
public class ModuleNamingContextImpl extends NamingContextNodeImpl implements
	...
	protected EClass eStaticClass() {
		return NameservicePackage.eINSTANCE.getModuleNamingContext();
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case NameservicePackage.MODULE_NAMING_CONTEXT__NODES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			case NameservicePackage.MODULE_NAMING_CONTEXT__CONSTRAINT:
				return getConstraint();
			case NameservicePackage.MODULE_NAMING_CONTEXT__CORBA_OBJECT:
				return getCorbaObject();
			case NameservicePackage.MODULE_NAMING_CONTEXT__NAME_SERVICE_REFERENCE:
				if (resolve) return getNameServiceReference();
				return basicGetNameServiceReference();
			case NameservicePackage.MODULE_NAMING_CONTEXT__NODES:
				return getNodes();
			case NameservicePackage.MODULE_NAMING_CONTEXT__ZOMBIE:
