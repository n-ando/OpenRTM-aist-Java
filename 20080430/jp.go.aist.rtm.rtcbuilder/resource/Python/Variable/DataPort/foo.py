...
class foo(OpenRTM.DataFlowComponentBase):
	...
	def __init__(self, manager):
		...
		self._d_VarInP1 = RTC.TimedShort(RTC.Time(0,0),0)
		"""
		"""
		self._InP1In = OpenRTM.InPort("InP1", self._d_VarInP1, OpenRTM.RingBuffer(8))
		...
		self._d_VarOutP2 = RTC.TimedFloat(RTC.Time(0,0),0)
		"""
		"""
		self._OutP2Out = OpenRTM.OutPort("OutP2", self._d_VarOutP2, OpenRTM.RingBuffer(8))
