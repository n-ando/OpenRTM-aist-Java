...
class foo(OpenRTM.DataFlowComponentBase):
	...
	def __init__(self, manager):
		...
		"""
		"""
		self._acinst = MyService_i()
		

		"""
		"""
		self._rinst = OpenRTM.CorbaConsumer(interfaceType=_GlobalIDL.DAQService)
		
		# Set service provider to Ports
		self._svPortPort.registerProvider("acc", "MyService", self._acinst)
		
		# Set service consumers to Ports
		self._cmPortPort.registerConsumer("rate", "DAQService", self._rinst)
