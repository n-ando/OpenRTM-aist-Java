...
class foo(OpenRTM.DataFlowComponentBase):
	...
	def __init__(self, manager):
		...
		"""
		"""
		self._acvaria = MyService_i()
		

		"""
		"""
		self._rvaria = OpenRTM.CorbaConsumer(interfaceType=_GlobalIDL.DAQService)
		
		# Set service provider to Ports
		self._svPortPort.registerProvider("acc", "MyService", self._acvaria)
		
		# Set service consumers to Ports
		self._cmPortPort.registerConsumer("rate", "DAQService", self._rvaria)
