...
class _objref_DAQService (CORBA.Object):
    ...
    __methods__ = ["setCommand", "getCommand"] + CORBA.Object.__methods__
...
class DAQService (PortableServer.Servant):
    ...
    _omni_op_d = {"setCommand": _0__GlobalIDL.DAQService._d_setCommand, "getCommand": _0__GlobalIDL.DAQService._d_getCommand}
