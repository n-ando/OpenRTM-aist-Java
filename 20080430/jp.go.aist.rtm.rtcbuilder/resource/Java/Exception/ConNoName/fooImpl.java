...
public class fooImpl extends DataFlowComponentBase {
   ...
   */
	public fooImpl(Manager manager) {  
        ...
        m_MyConProPort.registerConsumer("", "MyService", m_Base);
...
//
    ...
    protected CorbaConsumer<MyService> m_Base = new CorbaConsumer<MyService>(MyService.class);
    /*!
     */
    protected MyService m_;
