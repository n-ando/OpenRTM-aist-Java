package jp.go.aist.rtm.rtctemplate.generator;
...
import jp.go.aist.rtm.rtctemplate.corba.idl.parser.syntaxtree.Node;
import jp.go.aist.rtm.rtctemplate.corba.idl.parser.syntaxtree.NodeToken;
import jp.go.aist.rtm.rtctemplate.corba.idl.parser.syntaxtree.base_type_spec;
import jp.go.aist.rtm.rtctemplate.corba.idl.parser.syntaxtree.identifier;
import jp.go.aist.rtm.rtctemplate.corba.idl.parser.syntaxtree.interface_dcl;
import jp.go.aist.rtm.rtctemplate.corba.idl.parser.syntaxtree.interface_header;
import jp.go.aist.rtm.rtctemplate.corba.idl.parser.syntaxtree.module;
import jp.go.aist.rtm.rtctemplate.corba.idl.parser.syntaxtree.op_dcl;
import jp.go.aist.rtm.rtctemplate.corba.idl.parser.syntaxtree.param_dcl;
import jp.go.aist.rtm.rtctemplate.corba.idl.parser.syntaxtree.scoped_name;
import jp.go.aist.rtm.rtctemplate.corba.idl.parser.syntaxtree.simple_declarator;
import jp.go.aist.rtm.rtctemplate.corba.idl.parser.syntaxtree.simple_type_spec;
import jp.go.aist.rtm.rtctemplate.corba.idl.parser.syntaxtree.specification;
import jp.go.aist.rtm.rtctemplate.corba.idl.parser.syntaxtree.struct_type;
import jp.go.aist.rtm.rtctemplate.corba.idl.parser.syntaxtree.type_declarator;
import jp.go.aist.rtm.rtctemplate.corba.idl.parser.syntaxtree.type_spec;
import jp.go.aist.rtm.rtctemplate.corba.idl.parser.visitor.DepthFirstVisitor;
import jp.go.aist.rtm.rtctemplate.corba.idl.parser.visitor.GJNoArguDepthFirst;
import jp.go.aist.rtm.rtctemplate.corba.idl.parser.visitor.GJVoidDepthFirst;
...
//	/**
//	 * IDLの構文解析木から、structを探索する
//	 * 
//	 * @param spec
//	 * @return HashMap
//	 */
//	public static Map<String,String> convert_struct(specification spec,
//			final String idlPath) {
//		final HashMap<String, String> result = new HashMap<String, String>();
//		final Vector<String> typeKeys = new Vector<String>();
//		final Vector<String> typeValues = new Vector<String>();
