...
import jp.go.aist.rtm.rtctemplate.template.cppwin.CXXWinConverter;

/**
 * CXXファイルの出力を制御するマネージャ
 */
public class CXXWinGenerateManager implements GenerateManager {
	...
	public List<GeneratedResult> doGenerate(GeneratorParam generatorParam) {
		...
		for (RtcParam rtcParam : generatorParam.getRtcParams()) {
			...
			if (rtcParam.isLanguageExist(RtcParam.LANG_CPPWIN)) {
	...
	protected List<GeneratedResult> generateCompSource(RtcParam rtcParam, List<GeneratedResult> result) {
		...
		ins = CXXWinGenerateManager.class.getClassLoader()	
			.getResourceAsStream("jp/go/aist/rtm/rtctemplate/template/cppwin/CXX_Comp_src.template");
	...
	protected List<GeneratedResult> generateMakeFile(RtcParam rtcParam, Map contextMap, List<GeneratedResult> result) {
		...
		ins = CXXWinGenerateManager.class.getClassLoader()	
			.getResourceAsStream("jp/go/aist/rtm/rtctemplate/template/cppwin/CXX_Makefile_src.template");
	...
	protected List<GeneratedResult> generateRTCHeader(RtcParam rtcParam, Map contextMap, List<GeneratedResult> result) {
		...
		ins = CXXWinGenerateManager.class.getClassLoader()	
			.getResourceAsStream("jp/go/aist/rtm/rtctemplate/template/cppwin/CXX_RTC_Header_src.template");
	...
	protected List<GeneratedResult> generateRTCSource(RtcParam rtcParam, List<GeneratedResult> result) {
		...
		ins = CXXWinGenerateManager.class.getClassLoader()	
			.getResourceAsStream("jp/go/aist/rtm/rtctemplate/template/cppwin/CXX_RTC_Source_src.template");
	...
	protected List<GeneratedResult> generateRTCExtend(RtcParam rtcParam, Map contextMap, List<GeneratedResult> result) {
		...
		ins = CXXWinGenerateManager.class.getClassLoader()	
			.getResourceAsStream("jp/go/aist/rtm/rtctemplate/template/cppwin/CXX_RTM_Project_src.template");
		result.add(TemplateUtil.createGeneratedResult(ins, "rtcParam", rtcParam, "OpenRTM-aist.vsprops"));

		ins = CXXWinGenerateManager.class.getClassLoader()	
		.getResourceAsStream("jp/go/aist/rtm/rtctemplate/template/cppwin/CXX_Project_src.template");
		result.add(TemplateUtil.createGeneratedResult(ins, contextMap, rtcParam.getName() + ".vcproj"));
	...
	protected List<GeneratedResult> generateSVCHeader(IdlFileParam idlFileParm, Map contextMap, List<GeneratedResult> result) {
		...
		ins = CXXWinGenerateManager.class.getClassLoader()	
			.getResourceAsStream("jp/go/aist/rtm/rtctemplate/template/cppwin/CXX_SVC_Header_src.template");
	...
	protected List<GeneratedResult> generateSVCSource(IdlFileParam idlFileParm, Map contextMap, List<GeneratedResult> result) {
		...
		ins = CXXWinGenerateManager.class.getClassLoader()	
			.getResourceAsStream("jp/go/aist/rtm/rtctemplate/template/cppwin/CXX_SVC_Source_src.template");
		result.add(TemplateUtil.createGeneratedResult(ins, contextMap, 
								new TemplateHelper().getBasename(idlFileParm.getIdlFileNoExt())
