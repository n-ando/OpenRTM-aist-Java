package jp.go.aist.rtm.rtctemplate.template.java;
...
public class JavaConverter {
	...
	protected Map mapTypeHolder;
	protected Map mapParamHolder;
...
//	private final String javaLongDouble = "double";
	...
	public String convCORBA2Java(String strCorba, ServiceClassParam scp) {
		...
		String result = (String)mapType.get(strType);
	...
	public String convCORBA2JavaNoDef(String strCorba) {
		String result = (String)mapType.get(strCorba);
		if( result == null ) result = strCorba;
		return result;
	}
	/**
	...
	public String convCORBA2JavaforArg(String strCorba, String strDirection, ServiceClassParam scp) {
		...
		if( strType==null ) {
			if( strDirection.equals(dirIn) ) {
				result = (String)mapType.get(strCorba);
				if( result == null ) result = strCorba;
			} else {
				result = (String)mapTypeHolder.get(strCorba);
			...
			result = (String)mapType.get(strType);
			if( result == null ) {
				result = strType;
	 ...
	 * @return JavaŒ^
	 */
	public String convCORBA2JavaforArgNoDef(String strCorba, String strDirection) {
		String result = "";
		if( strDirection.equals(dirIn) ) {
			result = (String)mapType.get(strCorba);
		} else {
