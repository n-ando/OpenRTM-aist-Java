package jp.go.aist.rtm.rtctemplate.ui.compare;
...
public class CompareResultDialog extends Dialog {
	...
	protected Point getInitialSize() {
		...
		IDialogSettings bounds = RtctemplatePlugin.getDefault()
	...
	private void saveBounds(Rectangle bounds) {
		IDialogSettings dialogBounds = RtctemplatePlugin.getDefault()
				.getDialogSettings().getSection(DIALOG_BOUNDS_KEY);
		if (dialogBounds == null) {
			dialogBounds = new DialogSettings(DIALOG_BOUNDS_KEY);
			RtctemplatePlugin.getDefault().getDialogSettings().addSection(
					dialogBounds);
		}
