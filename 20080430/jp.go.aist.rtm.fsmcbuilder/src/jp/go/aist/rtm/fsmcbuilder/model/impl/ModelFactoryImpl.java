...
public class ModelFactoryImpl extends EFactoryImpl implements ModelFactory {
	...
	public static ModelFactory init() {
		try {
			ModelFactory theModelFactory = (ModelFactory)EPackage.Registry.INSTANCE.getEFactory("http:///jp/go/aist/rtm/fsmbuilder/model.ecore"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ModelPackage.STATE_MACHINE_DIAGRAM: return createStateMachineDiagram();
