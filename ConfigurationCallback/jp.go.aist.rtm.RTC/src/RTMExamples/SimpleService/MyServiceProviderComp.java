...
public class MyServiceProviderComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(MyServiceProvider.component_conf);
      mgr.registerFactory(prop, new MyServiceProvider(), new MyServiceProvider());

      // Create a component
      RTObject_impl comp = mgr.createComponent("MyServiceProvider");
