...
/*!
 * @class AutoTestInComp
 * @brief Standalone component Class
 *
 */
public class AutoTestInComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(AutoTestIn.component_conf);
      mgr.registerFactory(prop, new AutoTestIn(), new AutoTestIn());

      // Create a component
      RTObject_impl comp = mgr.createComponent("AutoTestIn");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        AutoTestInComp init = new AutoTestInComp();
