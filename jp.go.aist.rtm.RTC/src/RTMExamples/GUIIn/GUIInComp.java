...
public class GUIInComp implements ModuleInitProc {
    ...
    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(GUIIn.component_conf);
      mgr.registerFactory(prop, new GUIIn(), new GUIIn());

      // Create a component
      RTObject_impl comp = mgr.createComponent("GUIIn");
