...
public class MyServiceConsumerComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(MyServiceConsumer.component_conf);
      mgr.registerFactory(prop, new MyServiceConsumer(), new MyServiceConsumer());

      // Create a component
      RTObject_impl comp = mgr.createComponent("MyServiceConsumer");
