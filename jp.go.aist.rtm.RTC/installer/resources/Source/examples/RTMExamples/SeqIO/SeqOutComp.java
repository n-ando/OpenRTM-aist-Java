...
public class SeqOutComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(SeqOut.component_conf);
      mgr.registerFactory(prop, new SeqOut(), new SeqOut());

      RTObject_impl comp = mgr.createComponent("SeqOut");
