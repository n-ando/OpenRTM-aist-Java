...
#export CLASSPATH=.:$RTM_JAVA_ROOT/jar/OpenRTM-aist-0.4.0.jar:$RTM_JAVA_ROOT/jar/commons-cli-1.1.jar
...
#../../../jdk1.5.0_15/bin/java  RTMExamples.SimpleIO.ConsoleOutComp -f RTMExamples/SimpleIO/rtc.conf
