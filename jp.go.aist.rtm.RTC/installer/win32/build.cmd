...
if not DEFINED RTM_JAVA_VER  set RTM_JAVA_VER=1.1.1
...
@set TARGET_FULL=%TARGET%_%RTM_JAVA_VER%-RELEASE_%ARCH%
if "x%ARCH%" == "xx86_64" (
...
@set PRODUCT_NAME=OpenRTM-aist-%RTM_JAVA_VER%-RELEASE (%OS_ARCH%) for Java
...
@set OPENRTM_JAVA=%DISTRIBUTION%\OpenRTM-aist-Java-%RTM_JAVA_VER%
...
@rem ============================================================
@rem Make OpenRTM-aist-Java file list
@rem ============================================================
python OpenRTMjavawxs.py
