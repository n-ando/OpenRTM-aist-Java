...
//            return null;
    ...
    /**
     * <p>getLogbuf()メソッドのテスト
     * <ul>
     * <li>ログバッファを正しく取得でき、さらにオープンされているか？</li>
     * </ul>
     * </p>
     */
...
/*
        ...
        String testPath = rootPath + "tests\\fixtures\\Manager\\fixture1.conf";
...
*/
    ...
    public void test_runManager_no_block() throws Exception {
        ...
        byte[] oid = poa.activate_object(rto);
...
//            m_mgr.runManager(false); // true:非ブロッキング，false:ブロッキング
     ...
     * <p>load()メソッドのテスト
     * <ul>
     * <li>指定したモジュールをロードして、指定の初期化関数が正しく呼び出されるか？</li>
     * </ul>
     * </p>
     */
...
/*
        ...
        try {
            m_mgr.unload("jp.go.aist.rtm.RTC.sample.loadDummy");
            fail();
...
/*
        ...
        m_mgr.load("jp.go.aist.rtm.RTC.sample.loadSample", "addInitProcCount");
        m_mgr.load("jp.go.aist.rtm.RTC.sample.loadSample2", "addInitProcCount");

        assertTrue( isFound(m_mgr.getLoadedModules(), "jp.go.aist.rtm.RTC.sample.loadSample"));
        assertTrue( isFound(m_mgr.getLoadedModules(), "jp.go.aist.rtm.RTC.sample.loadSample2"));
        m_mgr.unloadAll();
        assertFalse( isFound(m_mgr.getLoadedModules(), "jp.go.aist.rtm.RTC.sample.loadSample"));
...
*/
    ...
    public void test_getModulesFactories() {
        ...
        assertEquals(2, m_mgr.getModulesFactories().size());
...
/*
        ...
        ExecutionContext[] ecList = comp.get_contexts();
