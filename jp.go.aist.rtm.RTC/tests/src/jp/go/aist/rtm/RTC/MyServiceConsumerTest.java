...
import RTMExamples.SimpleService.MyServiceConsumerComp;
import _SDOPackage.NVListHolder;

/**
* MyServiceConsumer　テスト(21)
* 対象クラス：MyServiceConsumer, MyServiceConsumerComp
*/
public class MyServiceConsumerTest extends SampleTest {
    ...
    protected void setUp() throws Exception {
        ...
        MyServiceConsumerComp init = new MyServiceConsumerComp();
      ...
      manager.registerFactory(prop, new MyServiceConsumer(), new MyServiceConsumer());
...
//        assertEquals("ConsoleIn0", comp.get_component_profile().instance_name);
        assertEquals("MyServiceConsumer", comp.get_component_profile().type_name);
        assertEquals("MyService Consumer Sample component", comp.get_component_profile().description);
        ...
        for(int intIdx=0;intIdx<portint.value.length;intIdx++) {
            ...
            assertEquals(PortInterfacePolarity.REQUIRED,portint.value[intIdx].polarity);
