 ...
 *
 */
public class MotorComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(Motor.component_conf);
      mgr.registerFactory(prop, new Motor(), new Motor());

      // Create a component
      RTObject_impl comp = mgr.createComponent("Motor");
      if( comp==null ) {
