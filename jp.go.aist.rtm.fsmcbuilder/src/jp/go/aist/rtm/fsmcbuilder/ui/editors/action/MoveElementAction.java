...
public class MoveElementAction extends SelectionAction {
	 ...
	 * 小さく上に移動するアクションのID
	 */
	public static final String MOVE_UP_ACTION_ID = MoveElementAction.class.getName()	+ "_UP";

	/**
	 * 小さく下に移動するアクションのID
	 */
	public static final String MOVE_DOWN_ACTION_ID = MoveElementAction.class.getName() + "_DOWN";

	/**
	 * 小さく右に移動するアクションのID
	 */
	public static final String MOVE_RIGHT_ACTION_ID = MoveElementAction.class.getName() + "_RIGHT";

	/**
	 * 小さく左に移動するアクションのID
	 */
	public static final String MOVE_LEFT_ACTION_ID = MoveElementAction.class.getName() + "_LEFT";

	/**
	 * 大きく上に移動するアクションのID
	 */
	public static final String MOVE_UP_L_ACTION_ID = MoveElementAction.class.getName() + "_UP_L";

	/**
	 * 大きく下に移動するアクションのID
	 */
	public static final String MOVE_DOWN_L_ACTION_ID = MoveElementAction.class.getName()	+ "_DOWN_L";

	/**
	 * 大きく右に移動するアクションのID
	 */
	public static final String MOVE_RIGHT_L_ACTION_ID = MoveElementAction.class.getName() + "_RIGHT_L";

	/**
	 * 大きく左に移動するアクションのID
	 */
	public static final String MOVE_LEFT_L_ACTION_ID = MoveElementAction.class.getName()	+ "_LEFT_L";
	 ...
	 * @param id　アクションのID
	 */
	public MoveElementAction(IWorkbenchPart part, String id) {
		super(part);
		setId(id);
		setText("Move");
	}
	...
	protected Command createMoveCommand(List selectedEditParts) {
		if( selectedEditParts.isEmpty() ) return null;
		if( !(selectedEditParts.get(0) instanceof EditPart) ) return null;
