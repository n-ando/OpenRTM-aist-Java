...
public class CommandLineParser {
	...
	private List<String> convArg2Lang(List<String> listArg) {
		...
		mapArg.put(RtcParam.LANG_CPP_ARG, RtcParam.LANG_CPP);
		mapArg.put(RtcParam.LANG_CPPWIN_ARG, RtcParam.LANG_CPPWIN);
		mapArg.put(RtcParam.LANG_JAVA_ARG, RtcParam.LANG_JAVA);
		mapArg.put(RtcParam.LANG_PYTHON_ARG, RtcParam.LANG_PYTHON);
