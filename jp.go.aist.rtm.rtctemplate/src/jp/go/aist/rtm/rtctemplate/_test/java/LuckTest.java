...
public class LuckTest extends TestBase {
	...
	public void testConsumerNoType() throws Exception{
		String resourceDir = "Java\\Exception\\ConNoName";
		...
		genParam.addProviderIDLPath(rootPath + "\\resource\\Java\\Exception\\ConNoName\\MyService.idl");
		...
		genParam.addConsumerIDLPath(rootPath + "\\resource\\Java\\Exception\\ConNoName\\MyService.idl");
	...
	public void testConsumerNoName() throws Exception{
		...
		String targetDir = rootPath + "\\resource\\Java\\Exception\\ConNoName\\";
	...
	public void testConsumerNoPortName() throws Exception{
		String resourceDir = "Java\\Exception\\ConNoPortName";
		GeneratorParam genParam = new GeneratorParam();
		genParam.setOutputDirectory(rootPath + "\\resource\\work");
		RtcParam rtcParam = new RtcParam(genParam);
		rtcParam.setLanguage(rtcParam.LANG_JAVA);
		...
		proport.add(new ServiceReferenceParam("MySVPro","myservice0","MyService", rtcParam));
		rtcParam.setProviderReferences(proport);
		genParam.addProviderIDLPath(rootPath + "\\resource\\Java\\Exception\\ConNoPortName\\MyService.idl");
		
		List<ServiceReferenceParam> conport = new ArrayList<ServiceReferenceParam>(); 
		conport.add(new ServiceReferenceParam("","myservice1","MyService", rtcParam));
		rtcParam.setConsumerReferences(conport);
		genParam.addConsumerIDLPath(rootPath + "\\resource\\Java\\Exception\\ConNoPortName\\MyService.idl");
		rtcParam.setOriginalConsumerIdls(new ArrayList<String>(genParam.getConsumerIDLPathParams()));
		rtcParam.setOriginalProviderIdls(new ArrayList<String>(genParam.getProviderIDLPathParams()));
		...
		String targetDir = rootPath + "\\resource\\Java\\Exception\\ConNoPortName\\";
		checkCode(result, targetDir, "fooComp.java");
		checkCode(result, targetDir, "build_foo.xml");
		checkCode(result, targetDir, "foo.java");
		checkCode(result, targetDir, "fooImpl.java");
	...
	public void testProviderNoType() throws Exception{
		String resourceDir = "Java\\Exception\\ProNoType";
		GeneratorParam genParam = new GeneratorParam();
		genParam.setOutputDirectory(rootPath + "\\resource\\work");
		RtcParam rtcParam = new RtcParam(genParam);
		rtcParam.setLanguage(rtcParam.LANG_JAVA);
		...
		rtcParam.setProviderReferences(proport);
		genParam.addProviderIDLPath(rootPath + "\\resource\\Java\\Exception\\ProNoType\\MyService.idl");
		rtcParam.setOriginalConsumerIdls(new ArrayList<String>(genParam.getConsumerIDLPathParams()));
		rtcParam.setOriginalProviderIdls(new ArrayList<String>(genParam.getProviderIDLPathParams()));
	...
	public void testProviderNoName() throws Exception{
		String resourceDir = "Java\\Exception\\ProNoName";
		GeneratorParam genParam = new GeneratorParam();
		genParam.setOutputDirectory(rootPath + "\\resource\\work");
		RtcParam rtcParam = new RtcParam(genParam);
		rtcParam.setLanguage(rtcParam.LANG_JAVA);
		...
		rtcParam.setProviderReferences(proport);
		genParam.addProviderIDLPath(rootPath + "\\resource\\Java\\Exception\\ProNoName\\MyService.idl");
		rtcParam.setOriginalConsumerIdls(new ArrayList<String>(genParam.getConsumerIDLPathParams()));
		rtcParam.setOriginalProviderIdls(new ArrayList<String>(genParam.getProviderIDLPathParams()));
		...
		String targetDir = rootPath + "\\resource\\Java\\Exception\\ProNoName\\";
		checkCode(result, targetDir, "fooComp.java");
		checkCode(result, targetDir, "build_foo.xml");
		checkCode(result, targetDir, "foo.java");
		checkCode(result, targetDir, "fooImpl.java");
	...
	public void testProviderNoPortName() throws Exception{
		String resourceDir = "Java\\Exception\\ProNoPortName";
		GeneratorParam genParam = new GeneratorParam();
		genParam.setOutputDirectory(rootPath + "\\resource\\work");
		RtcParam rtcParam = new RtcParam(genParam);
		rtcParam.setLanguage(rtcParam.LANG_JAVA);
		...
		rtcParam.setProviderReferences(proport);
		genParam.addProviderIDLPath(rootPath + "\\resource\\Java\\Exception\\ProNoPortName\\MyService.idl");
		rtcParam.setOriginalConsumerIdls(new ArrayList<String>(genParam.getConsumerIDLPathParams()));
		rtcParam.setOriginalProviderIdls(new ArrayList<String>(genParam.getProviderIDLPathParams()));
		...
		String targetDir = rootPath + "\\resource\\Java\\Exception\\ProNoPortName\\";
		checkCode(result, targetDir, "fooComp.java");
		checkCode(result, targetDir, "build_foo.xml");
		checkCode(result, targetDir, "foo.java");
		checkCode(result, targetDir, "fooImpl.java");
	...
	public void testOutPortNoType() throws Exception{
		String resourceDir = "Java\\Exception\\OutPortNoType";
		GeneratorParam genParam = new GeneratorParam();
		genParam.setOutputDirectory(rootPath + "\\resource\\work");
		RtcParam rtcParam = new RtcParam(genParam);
		rtcParam.setLanguage(rtcParam.LANG_JAVA);
		...
		String targetDir = rootPath + "\\resource\\Java\\Exception\\OutPortNoType\\";
		checkCode(result, targetDir, "fooComp.java");
		checkCode(result, targetDir, "build_foo.xml");
		checkCode(result, targetDir, "foo.java");
		checkCode(result, targetDir, "fooImpl.java");
	...
	public void testOutPortNoName() throws Exception{
		String resourceDir = "Java\\Exception\\OutPortNoName";
		GeneratorParam genParam = new GeneratorParam();
		genParam.setOutputDirectory(rootPath + "\\resource\\work");
		RtcParam rtcParam = new RtcParam(genParam);
		rtcParam.setLanguage(rtcParam.LANG_JAVA);
		...
		String targetDir = rootPath + "\\resource\\Java\\Exception\\OutPortNoName\\";
		checkCode(result, targetDir, "fooComp.java");
		checkCode(result, targetDir, "build_foo.xml");
		checkCode(result, targetDir, "foo.java");
		checkCode(result, targetDir, "fooImpl.java");
	...
	public void testInPortNoType() throws Exception{
		String resourceDir = "Java\\Exception\\InPortNoType";
		GeneratorParam genParam = new GeneratorParam();
		genParam.setOutputDirectory(rootPath + "\\resource\\work");
		RtcParam rtcParam = new RtcParam(genParam);
		rtcParam.setLanguage(rtcParam.LANG_JAVA);
		...
		String targetDir = rootPath + "\\resource\\Java\\Exception\\InPortNoType\\";
		checkCode(result, targetDir, "fooComp.java");
		checkCode(result, targetDir, "build_foo.xml");
		checkCode(result, targetDir, "foo.java");
		checkCode(result, targetDir, "fooImpl.java");
	...
	public void testInPortNoName() throws Exception{
		String resourceDir = "Java\\Exception\\InPortNoName";
		GeneratorParam genParam = new GeneratorParam();
		genParam.setOutputDirectory(rootPath + "\\resource\\work");
		RtcParam rtcParam = new RtcParam(genParam);
		rtcParam.setLanguage(rtcParam.LANG_JAVA);
		...
		String targetDir = rootPath + "\\resource\\Java\\Exception\\InPortNoName\\";
		checkCode(result, targetDir, "fooComp.java");
		checkCode(result, targetDir, "build_foo.xml");
		checkCode(result, targetDir, "foo.java");
		checkCode(result, targetDir, "fooImpl.java");
