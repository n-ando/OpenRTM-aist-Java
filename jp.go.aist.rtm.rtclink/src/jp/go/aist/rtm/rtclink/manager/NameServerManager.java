...
import jp.go.aist.rtm.rtclink.model.nameservice.impl.NamingContextNodeImpl;
...
public class NameServerManager extends NamingContextNodeImpl {
	...
	public NameServerNamingContext addNameServer(String nameServer) {
		...
		NameServerNamingContext result = CorbaWrapperFactory.getInstance()
	...
	public void refreshAll() {
		...
		// refresh中にnameServerNamingContextListが変更されるため。
	...
	public void synchronizeAll() {
		...
		for (NameServerNamingContext nameServerNamingContext : unModifyList) {
			nameServerNamingContext.getSynchronizationSupport().synchronizeLocal();
		}
	}
