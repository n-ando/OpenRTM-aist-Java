package jp.go.aist.rtm.rtclink.ui.views.configurationview;
...
import jp.go.aist.rtm.rtclink.model.component.impl.ConfigurationSetImpl;
import jp.go.aist.rtm.rtclink.ui.views.configurationview.configurationwrapper.ComponentConfigurationWrapper;
import jp.go.aist.rtm.rtclink.ui.views.configurationview.configurationwrapper.ConfigurationSetConfigurationWrapper;
import jp.go.aist.rtm.rtclink.ui.views.configurationview.configurationwrapper.NamedValueConfigurationWrapper;
...
public class ConfigurationView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		applyButton.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				if (targetComponent.getComponentState() == LifeCycleState.RTC_ACTIVE
		...
		for (ConfigurationSetConfigurationWrapper configset : copiedComponent
			...
			for (NamedValueConfigurationWrapper namedValue : configset
				...
				configurationSet.getConfigurationData().add(
						CorbaWrapperFactory.getInstance().createWrapperObject(
								namedValue.getKey(), namedValue.getValue()));
			}
	...
	private void setLastNameServiceAddress(String address) {
		RtcLinkPlugin.getDefault().getPreferenceStore().setValue(
		...
		public void selectionChanged(IWorkbenchPart part, ISelection selection) {
			...
			if (selection instanceof IStructuredSelection) {
				...
				if (AdapterUtil.getAdapter(sSelection.getFirstElement(),
					...
					targetComponent = (Component) AdapterUtil.getAdapter(
