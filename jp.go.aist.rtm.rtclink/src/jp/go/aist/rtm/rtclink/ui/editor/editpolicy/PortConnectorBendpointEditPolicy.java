...
import jp.go.aist.rtm.rtclink.ui.editor.command.MoveLineCommand;
import jp.go.aist.rtm.rtclink.ui.editor.editpart.router.LineMoveHandle;
...
public class PortConnectorBendpointEditPolicy extends
	...
	protected Command getMoveBendpointCommand(BendpointRequest request) {
		...
		result
				.setModel((jp.go.aist.rtm.rtclink.model.component.Connector) getHost()
						.getModel());
