...
public class CoreFactoryImpl extends EFactoryImpl implements CoreFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case CorePackage.CORBA_WRAPPER_OBJECT: return createCorbaWrapperObject();
	 ...
	 * @generated
	 */
	public CorbaWrapperObject createCorbaWrapperObject() {
		CorbaWrapperObjectImpl corbaWrapperObject = new CorbaWrapperObjectImpl();
		return corbaWrapperObject;
	}
