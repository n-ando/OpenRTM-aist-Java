...
import jp.go.aist.rtm.rtclink.corba.NameServerAccesser;
 ...
 * <ul>
 *   <li>{@link jp.go.aist.rtm.rtclink.model.nameservice.impl.NameServiceReferenceImpl#getBinding <em>Binding</em>}</li>
 *   <li>{@link jp.go.aist.rtm.rtclink.model.nameservice.impl.NameServiceReferenceImpl#getNameServerName <em>Name Server Name</em>}</li>
 *   <li>{@link jp.go.aist.rtm.rtclink.model.nameservice.impl.NameServiceReferenceImpl#getRootNamingContext <em>Root Naming Context</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NameServiceReferenceImpl extends EObjectImpl implements
	...
	protected EClass eStaticClass() {
		return NameservicePackage.eINSTANCE.getNameServiceReference();
	}
