...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Host Naming Context</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class HostNamingContextImpl extends NamingContextNodeImpl implements
		HostNamingContext {
	/**
	...
	protected EClass eStaticClass() {
		return NameservicePackage.eINSTANCE.getHostNamingContext();
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case NameservicePackage.HOST_NAMING_CONTEXT__NODES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			case NameservicePackage.HOST_NAMING_CONTEXT__CONSTRAINT:
				return getConstraint();
			case NameservicePackage.HOST_NAMING_CONTEXT__CORBA_OBJECT:
				return getCorbaObject();
			case NameservicePackage.HOST_NAMING_CONTEXT__NAME_SERVICE_REFERENCE:
				if (resolve) return getNameServiceReference();
				return basicGetNameServiceReference();
			case NameservicePackage.HOST_NAMING_CONTEXT__NODES:
				return getNodes();
			case NameservicePackage.HOST_NAMING_CONTEXT__ZOMBIE:
