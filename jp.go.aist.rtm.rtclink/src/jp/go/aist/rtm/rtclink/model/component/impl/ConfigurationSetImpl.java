 ...
 * <ul>
 *   <li>{@link jp.go.aist.rtm.rtclink.model.component.impl.ConfigurationSetImpl#getId <em>Id</em>}</li>
 *   <li>{@link jp.go.aist.rtm.rtclink.model.component.impl.ConfigurationSetImpl#getSDOConfigurationSet <em>SDO Configuration Set</em>}</li>
 *   <li>{@link jp.go.aist.rtm.rtclink.model.component.impl.ConfigurationSetImpl#getConfigurationData <em>Configuration Data</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConfigurationSetImpl extends WrapperObjectImpl implements
    ...
    protected EClass eStaticClass() {
		return ComponentPackage.eINSTANCE.getConfigurationSet();
	}
    ...
    public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			case ComponentPackage.CONFIGURATION_SET__CONSTRAINT:
    ...
    // * @return
    // */
    // private List<jp.go.aist.rtm.rtclink.model.component.NameValue>
    // getKeyAndValueList() {
    // List<jp.go.aist.rtm.rtclink.model.component.NameValue> result = new
    // ArrayList<jp.go.aist.rtm.rtclink.model.component.NameValue>();
    // for (NameValue nameValue : delegate.configuration_data) {
    // result
    // .add((jp.go.aist.rtm.rtclink.model.component.NameValue)
    // CorbaWrapperFactory
