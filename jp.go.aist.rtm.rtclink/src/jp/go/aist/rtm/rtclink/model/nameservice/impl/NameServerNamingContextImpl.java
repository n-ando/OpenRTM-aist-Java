...
public class NameServerNamingContextImpl extends NamingContextNodeImpl
	...
	protected EClass eStaticClass() {
		return NameservicePackage.eINSTANCE.getNameServerNamingContext();
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case NameservicePackage.NAME_SERVER_NAMING_CONTEXT__NODES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			case NameservicePackage.NAME_SERVER_NAMING_CONTEXT__CONSTRAINT:
				return getConstraint();
			case NameservicePackage.NAME_SERVER_NAMING_CONTEXT__CORBA_OBJECT:
				return getCorbaObject();
			case NameservicePackage.NAME_SERVER_NAMING_CONTEXT__NAME_SERVICE_REFERENCE:
				if (resolve) return getNameServiceReference();
				return basicGetNameServiceReference();
			case NameservicePackage.NAME_SERVER_NAMING_CONTEXT__NODES:
				return getNodes();
			case NameservicePackage.NAME_SERVER_NAMING_CONTEXT__ZOMBIE:
