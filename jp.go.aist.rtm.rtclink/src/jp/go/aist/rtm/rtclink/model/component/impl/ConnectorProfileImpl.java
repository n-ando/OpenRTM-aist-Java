 ...
 * <ul>
 *   <li>{@link jp.go.aist.rtm.rtclink.model.component.impl.ConnectorProfileImpl#getDataflowType <em>Dataflow Type</em>}</li>
 *   <li>{@link jp.go.aist.rtm.rtclink.model.component.impl.ConnectorProfileImpl#getSubscriptionType <em>Subscription Type</em>}</li>
 *   <li>{@link jp.go.aist.rtm.rtclink.model.component.impl.ConnectorProfileImpl#isSubscriptionTypeAvailable <em>Subscription Type Available</em>}</li>
 *   <li>{@link jp.go.aist.rtm.rtclink.model.component.impl.ConnectorProfileImpl#isPushIntervalAvailable <em>Push Interval Available</em>}</li>
 *   <li>{@link jp.go.aist.rtm.rtclink.model.component.impl.ConnectorProfileImpl#getName <em>Name</em>}</li>
 *   <li>{@link jp.go.aist.rtm.rtclink.model.component.impl.ConnectorProfileImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link jp.go.aist.rtm.rtclink.model.component.impl.ConnectorProfileImpl#getConnectorId <em>Connector Id</em>}</li>
 *   <li>{@link jp.go.aist.rtm.rtclink.model.component.impl.ConnectorProfileImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link jp.go.aist.rtm.rtclink.model.component.impl.ConnectorProfileImpl#getInterfaceType <em>Interface Type</em>}</li>
 *   <li>{@link jp.go.aist.rtm.rtclink.model.component.impl.ConnectorProfileImpl#getPushRate <em>Push Rate</em>}</li>
 *   <li>{@link jp.go.aist.rtm.rtclink.model.component.impl.ConnectorProfileImpl#getRtcConnectorProfile <em>Rtc Connector Profile</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConnectorProfileImpl extends WrapperObjectImpl implements
	...
	protected EClass eStaticClass() {
		return ComponentPackage.eINSTANCE.getConnectorProfile();
	}
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			case ComponentPackage.CONNECTOR_PROFILE__CONSTRAINT:
